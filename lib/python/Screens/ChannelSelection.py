            ...
            if not inBouquetRootList:
                ...
                if isPlayable:
                    ...
                    if config.servicelist.startupservice.value == current.toString():
                        ...
                        append_when_current_valid(current, menu, (_('set as startup service'), self.setStartupService), level=0, key='4')
                    ...
                    if haveBouquets:
                        if not self.inBouquet and 'PROVIDERS' not in current_sel_path:
                            append_when_current_valid(current, menu, (_('copy to bouquets'), self.copyCurrentToBouquetList), level=0, key='3')
